...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2021 at 03:36 PM
...
--
-- Table structure for table `vc_admins`
--

CREATE TABLE `vc_admins` (
...
--
-- Dumping data for table `vc_admins`
--

INSERT INTO `vc_admins` (`id`, `username`, `password_hash`, `name`, `email`, `image`, `permission`) VALUES
(1, 'admin', '$2y$13$GOp2rgrGK.McAEl9Ocjmue/bhF.L5jUex2sO4gD7Ej0zJruaKxd8S', 'Admin', 'admin@demo.com', '', '0');

-- --------------------------------------------------------

--
-- Table structure for table `vc_balance`
--

CREATE TABLE `vc_balance` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data for table `vc_balance`
--

INSERT INTO `vc_balance` (`id`, `current_balance`, `total_earning`, `total_withdrawal`) VALUES
(1, 0.00, 0.00, 0.00);

-- --------------------------------------------------------

--
-- Table structure for table `vc_blog`
--

CREATE TABLE `vc_blog` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data for table `vc_blog`
--

INSERT INTO `vc_blog` (`id`, `author`, `title`, `description`, `image`, `tags`, `status`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `vc_blog_categories`
--

CREATE TABLE `vc_blog_categories` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data for table `vc_blog_categories`
--

INSERT INTO `vc_blog_categories` (`id`, `title`, `slug`, `position`, `active`) VALUES
...
--
-- Table structure for table `vc_blog_cat_relation`
--

CREATE TABLE `vc_blog_cat_relation` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data for table `vc_blog_cat_relation`
--

INSERT INTO `vc_blog_cat_relation` (`id`, `blog_id`, `category_id`) VALUES
(3, 1, 1),
(4, 1, 2);
...
--
-- Table structure for table `vc_blog_comment`
--

CREATE TABLE `vc_blog_comment` (
  `id` int(10) NOT NULL,
  `blog_id` int(10) DEFAULT NULL,
...
--
-- Table structure for table `vc_countries`
--

CREATE TABLE `vc_countries` (
...
--
-- Dumping data for table `vc_countries`
--

INSERT INTO `vc_countries` (`id`, `code`, `latitude`, `longitude`, `iso3`, `iso_numeric`, `fips`, `name`, `asciiname`, `capital`, `area`, `population`, `continent_code`, `tld`, `currency_code`, `phone`, `postal_code_format`, `postal_code_regex`, `languages`, `neighbours`, `equivalent_fips_code`, `active`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `vc_currencies`
--

CREATE TABLE `vc_currencies` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `vc_currencies`
--

INSERT INTO `vc_currencies` (`id`, `code`, `name`, `html_entity`, `font_arial`, `font_code2000`, `unicode_decimal`, `unicode_hex`, `in_left`, `decimal_places`, `decimal_separator`, `thousand_separator`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `vc_faq_entries`
--

CREATE TABLE `vc_faq_entries` (
...
--
-- Dumping data for table `vc_faq_entries`
--

INSERT INTO `vc_faq_entries` (`faq_id`, `translation_lang`, `translation_of`, `parent_id`, `faq_pid`, `faq_weight`, `faq_title`, `faq_content`, `active`) VALUES
(1, 'en', 1, 1, 0, 0, 'Why FAQ Pages Are a Priority', '<p>FAQ pages continue to be a priority area for SEO and digital marketing professionals.</p><p>An FAQ page is one of the simplest ways to improve your site and help site visitors and users.</p>', 1),
(2, 'en', 2, 2, 0, 0, 'WhatsApp', '<p><span style=\"color: rgb(26, 26, 26); font-size: 24px;\">The&nbsp;</span>FAQ resource for Whatsapp<span style=\"color: rgb(26, 26, 26); font-size: 24px;\">&nbsp;is bright, easy to use, and categorized effectively for quick desktop or mobile use.</span><br></p>', 1);
...
--
-- Dumping data for table `vc_languages`
--

INSERT INTO `vc_languages` (`id`, `code`, `direction`, `name`, `file_name`, `active`, `default`) VALUES
(1, 'en', 'ltr', 'English', 'english', 1, 1),
(2, 'fr', 'ltr', 'French', 'french', 0, 0),
(3, 'sv', 'ltr', 'Swedish', 'swedish', 0, 0),
(4, 'it', 'ltr', 'Italian', 'italian', 0, 0),
(5, 'de', 'ltr', 'German', 'german', 0, 0),
(6, 'es', 'ltr', 'Spanish', 'spanish', 0, 0),
(7, 'pl', 'ltr', 'Polish', 'polish', 0, 0),
(8, 'ja', 'ltr', 'Japanese', 'japanese', 0, 0),
(9, 'zh', 'ltr', 'Chinese', 'chinese', 0, 0),
(10, 'ar', 'rtl', 'Arabic', 'arabic', 0, 0),
(11, 'he', 'rtl', 'Hebrew', 'hebrew', 0, 0),
(12, 'ru', 'ltr', 'Russian', 'russian', 0, 0),
(13, 'bn', 'ltr', 'Bangali', 'bangali', 0, 0),
(14, 'hi', 'ltr', 'Hindi', 'hindi', 0, 0),
(15, 'bg', 'ltr', 'Bulgarian', 'bulgarian', 0, 0),
(16, 'ro', 'ltr', 'Romanian', 'romanian', 0, 0),
(17, 'th', 'ltr', 'Thai', 'thai', 0, 0),
(18, 'tr', 'ltr', 'Turkish', 'turkish', 0, 0),
(19, 'ur', 'rtl', 'Urdu', 'urdu', 0, 0),
(20, 'vi', 'ltr', 'Vietnamese', 'vietnamese', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `vc_logs`
--

CREATE TABLE `vc_logs` (
...
--
-- Dumping data for table `vc_logs`
--

INSERT INTO `vc_logs` (`log_id`, `log_date`, `log_summary`, `log_details`) VALUES
(1, 1633168037, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(2, 1633168395, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(3, 1633169490, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(4, 1634993043, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(5, 1640150940, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(6, 1640151436, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(7, 1640156639, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(8, 1640156987, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(9, 1640157719, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds'),
(10, 1640158035, 'Cron Run', 'Expire membership: 0<br><br>Cron Took: 0 seconds');

-- --------------------------------------------------------

--
-- Table structure for table `vc_options`
--

CREATE TABLE `vc_options` (
...
--
-- Dumping data for table `vc_options`
--

INSERT INTO `vc_options` (`option_id`, `option_name`, `option_value`) VALUES
...
(29, 'copyright_text', '2021 Digital Card INC, All right reserved'),
...
(175, 'try_demo_link', ''),
(176, 'specific_country', 'US'),
(177, 'purchase_type', 'extended'),
(179, 'site_url', 'http://localhost/quickvcard/');

-- --------------------------------------------------------

--
-- Table structure for table `vc_pages`
--

CREATE TABLE `vc_pages` (
  `id` int(10) UNSIGNED NOT NULL,
  `translation_lang` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `translation_of` int(10) UNSIGNED DEFAULT NULL,
  `parent_id` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Dumping data for table `vc_payments`
--

INSERT INTO `vc_payments` (`payment_id`, `payment_install`, `payment_title`, `payment_folder`, `payment_desc`) VALUES
(1, '1', 'Paypal', 'paypal', 'You will be redirected to paypal to complete payment.');

-- --------------------------------------------------------

--
-- Table structure for table `vc_plans`
--

CREATE TABLE `vc_plans` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `vc_plan_options`
--

CREATE TABLE `vc_plan_options` (
  `id` int(11) NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `vc_taxes`
--

CREATE TABLE `vc_taxes` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Table structure for table `vc_testimonials`
--

CREATE TABLE `vc_testimonials` (
  `id` int(10) NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `vc_testimonials`
--

INSERT INTO `vc_testimonials` (`id`, `name`, `designation`, `content`, `image`) VALUES
...
--
-- Table structure for table `vc_time_zones`
--

CREATE TABLE `vc_time_zones` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `vc_time_zones`
--

INSERT INTO `vc_time_zones` (`id`, `country_code`, `time_zone_id`, `gmt`, `dst`, `raw`) VALUES
...
--
-- Table structure for table `vc_transaction`
--

CREATE TABLE `vc_transaction` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `vc_upgrades`
--

CREATE TABLE `vc_upgrades` (
...
INSERT INTO `vc_user` (`id`, `group_id`, `username`, `user_type`, `balance`, `password_hash`, `forgot`, `confirm`, `email`, `status`, `view`, `created_at`, `updated_at`, `name`, `tagline`, `description`, `dob`, `salary_min`, `salary_max`, `category`, `subcategory`, `website`, `sex`, `phone`, `postcode`, `address`, `country`, `city`, `city_code`, `state_code`, `country_code`, `image`, `lastactive`, `facebook`, `twitter`, `googleplus`, `instagram`, `linkedin`, `youtube`, `oauth_provider`, `oauth_uid`, `oauth_link`, `online`, `notify`, `notify_cat`, `currency`, `menu_layout`) VALUES
(1, 'free', 'guestuser', NULL, 0.00, '$2y$13$LTRrBFdp6j/fuhxES1PedeFazBLg46cDgpltLIo2WlbTTS/M66OkK', NULL, '96802525', 'guestuser@gmail.com', '0', NULL, '2021-12-22 02:15:50', '2021-12-22 02:15:50', 'Guest User', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'default_user.png', '2021-12-22 12:47:52', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, 'both');

-- --------------------------------------------------------

--
-- Table structure for table `vc_user_options`
--

CREATE TABLE `vc_user_options` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `vc_vcards`
--

CREATE TABLE `vc_vcards` (
  `id` int(11) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `vc_vcards`
--

INSERT INTO `vc_vcards` (`id`, `user_id`, `slug`, `color`, `title`, `sub_title`, `description`, `main_image`, `cover_image`, `details`, `created_at`) VALUES
(1, 1, 'example-user', '#ff4c60', 'Example User', 'I am just example user', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,\r\nmolestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum\r\nnumquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentium\r\noptio, eaque rerum! Provident similique accusantium nemo autem. Veritatis\r\nobcaecati tenetur iure eius earum ut molestias architecto voluptate aliquam\r\nnihil, eveniet aliquid culpa officia aut! Impedit sit sunt quaerat, odit,\r\ntenetur error, harum nesciunt ipsum debitis quas aliquid.', 'default.png', 'default.png', '[{\"value\":\"+91-4545454545\",\"label\":\"Connect With Me\",\"type\":\"phone\"}]', '2021-12-22 02:19:45');

-- --------------------------------------------------------

--
-- Table structure for table `vc_vcard_options`
--

CREATE TABLE `vc_vcard_options` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `vc_vcard_options`
--

INSERT INTO `vc_vcard_options` (`id`, `vcard_id`, `option_name`, `option_value`) VALUES
(1, 1, 'vcard_template', 'classic-theme');

-- --------------------------------------------------------

--
-- Table structure for table `vc_vcard_view`
--

CREATE TABLE `vc_vcard_view` (
  `id` int(11) NOT NULL,
  `vcard_id` int(11) DEFAULT NULL,
...
--
-- Indexes for table `vc_admins`
--
ALTER TABLE `vc_admins`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_balance`
--
ALTER TABLE `vc_balance`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_blog`
--
ALTER TABLE `vc_blog`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_blog_categories`
--
ALTER TABLE `vc_blog_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_blog_cat_relation`
--
ALTER TABLE `vc_blog_cat_relation`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_blog_comment`
--
ALTER TABLE `vc_blog_comment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_countries`
--
ALTER TABLE `vc_countries`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indexes for table `vc_currencies`
--
ALTER TABLE `vc_currencies`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`);

--
-- Indexes for table `vc_faq_entries`
--
ALTER TABLE `vc_faq_entries`
  ADD PRIMARY KEY (`faq_id`);

--
-- Indexes for table `vc_languages`
--
ALTER TABLE `vc_languages`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_logs`
--
ALTER TABLE `vc_logs`
  ADD PRIMARY KEY (`log_id`);

--
-- Indexes for table `vc_options`
--
ALTER TABLE `vc_options`
  ADD PRIMARY KEY (`option_id`),
  ADD UNIQUE KEY `option_name` (`option_name`);

--
-- Indexes for table `vc_pages`
--
ALTER TABLE `vc_pages`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_payments`
--
ALTER TABLE `vc_payments`
  ADD PRIMARY KEY (`payment_id`);

--
-- Indexes for table `vc_plans`
--
ALTER TABLE `vc_plans`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_plan_options`
--
ALTER TABLE `vc_plan_options`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_taxes`
--
ALTER TABLE `vc_taxes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_testimonials`
--
ALTER TABLE `vc_testimonials`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_time_zones`
--
ALTER TABLE `vc_time_zones`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `time_zone_id` (`time_zone_id`),
  ADD KEY `country_code` (`country_code`);

--
-- Indexes for table `vc_transaction`
--
ALTER TABLE `vc_transaction`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_upgrades`
--
ALTER TABLE `vc_upgrades`
...
--
-- Indexes for table `vc_user_options`
--
ALTER TABLE `vc_user_options`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_vcards`
--
ALTER TABLE `vc_vcards`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_vcard_options`
--
ALTER TABLE `vc_vcard_options`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vc_vcard_view`
--
ALTER TABLE `vc_vcard_view`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `vc_admins`
--
ALTER TABLE `vc_admins`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `vc_balance`
--
ALTER TABLE `vc_balance`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `vc_blog`
--
ALTER TABLE `vc_blog`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `vc_blog_categories`
--
ALTER TABLE `vc_blog_categories`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `vc_blog_cat_relation`
--
ALTER TABLE `vc_blog_cat_relation`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `vc_blog_comment`
--
ALTER TABLE `vc_blog_comment`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vc_countries`
--
ALTER TABLE `vc_countries`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=253;

--
-- AUTO_INCREMENT for table `vc_currencies`
--
ALTER TABLE `vc_currencies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT for table `vc_faq_entries`
--
ALTER TABLE `vc_faq_entries`
  MODIFY `faq_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `vc_languages`
--
ALTER TABLE `vc_languages`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `vc_logs`
--
ALTER TABLE `vc_logs`
  MODIFY `log_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `vc_options`
--
ALTER TABLE `vc_options`
  MODIFY `option_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;

--
-- AUTO_INCREMENT for table `vc_pages`
--
ALTER TABLE `vc_pages`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vc_payments`
--
ALTER TABLE `vc_payments`
  MODIFY `payment_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `vc_plans`
--
ALTER TABLE `vc_plans`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vc_plan_options`
--
ALTER TABLE `vc_plan_options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vc_taxes`
--
ALTER TABLE `vc_taxes`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vc_testimonials`
--
ALTER TABLE `vc_testimonials`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `vc_time_zones`
--
ALTER TABLE `vc_time_zones`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=248;

--
-- AUTO_INCREMENT for table `vc_transaction`
--
ALTER TABLE `vc_transaction`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vc_upgrades`
--
ALTER TABLE `vc_upgrades`
  MODIFY `upgrade_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `vc_user_options`
--
ALTER TABLE `vc_user_options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vc_vcards`
--
ALTER TABLE `vc_vcards`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `vc_vcard_options`
--
ALTER TABLE `vc_vcard_options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `vc_vcard_view`
--
ALTER TABLE `vc_vcard_view`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
